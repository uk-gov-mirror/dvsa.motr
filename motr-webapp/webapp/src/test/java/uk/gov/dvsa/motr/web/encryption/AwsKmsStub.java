...
public class AwsKmsStub implements AWSKMS {
    ...
    public AwsKmsStub setExpectedDecryptResult(DecryptResult expectedDecryptResult) {
        this.expectedDecryptResult = expectedDecryptResult;
        return this;
    }
