...
public class SubscriptionServiceTest {
    ...
    public void setUp() {
        ...
        this.subscriptionService = new SubscriptionService(SUBSCRIPTION_REPOSITORY);
    }
    ...
    public void saveSubscriptionWhenSubscriptionDoesNotExistCallsDbToSaveDetails() throws SubscriptionAlreadyExistsException {
        ...
        this.subscriptionService.saveSubscription(TEST_REG, EMAIL, LocalDate.now());
        verify(SUBSCRIPTION_REPOSITORY, times(1)).save(any(Subscription.class));
    }

    @Test(expected = SubscriptionAlreadyExistsException.class)
    public void throwsExceptionWhenSubscriptionAlreadyExists() throws SubscriptionAlreadyExistsException {
