...
import static uk.gov.dvsa.motr.notifier.processing.model.notification.email.HgvPsvOneMonthEmailNotification.HGV_PSV_PRESERVATION_STATEMENT_PREFIX;
import static uk.gov.dvsa.motr.notifier.processing.model.notification.email.HgvPsvOneMonthEmailNotification.IS_DUE_OR_EXPIRES_KEY;
import static uk.gov.dvsa.motr.notifier.processing.model.notification.email.HgvPsvOneMonthEmailNotification.MOT_EXPIRY_DATE_KEY;
import static uk.gov.dvsa.motr.notifier.processing.model.notification.email.HgvPsvOneMonthEmailNotification.PRESERVATION_STATEMENT_KEY;
...
public class HgvPsvOneMonthEmailNotificationTest {
    private static final String BASE_URL = "baseUrl.com";
    private HgvPsvOneMonthEmailNotification notification;
    ...
    @Before
    public void setUp() {
        notification = new HgvPsvOneMonthEmailNotification(BASE_URL);
    ...
    public void templateBodyPath_isCorrect() {
        assertEquals("hgv-psv/hgv-psv-one-month-notification-email-body.txt", notification.getNotificationPathBody());
    }

    @Test
    public void templateSubjectPath_isCorrect() {
        assertEquals("hgv-psv/hgv-psv-one-month-notification-email-subject.txt", notification.getNotificationPathSubject());
    }
