...
import static uk.gov.dvsa.motr.notifier.processing.model.notification.email.MotOneMonthEmailNotification.IS_DUE_OR_EXPIRES_KEY;
import static uk.gov.dvsa.motr.notifier.processing.model.notification.email.MotOneMonthEmailNotification.MOTH_URL_KEY;
import static uk.gov.dvsa.motr.notifier.processing.model.notification.email.MotOneMonthEmailNotification.MOT_EXPIRY_DATE_KEY;
import static uk.gov.dvsa.motr.notifier.processing.model.notification.email.MotOneMonthEmailNotification.PRESERVATION_STATEMENT_KEY;
import static uk.gov.dvsa.motr.notifier.processing.model.notification.email.SendableEmailNotification.MOT_PRESERVATION_STATEMENT_PREFIX;
...
public class MotOneMonthEmailNotificationTest {

    private static final String BASE_URL = "baseUrl.com";
    private MotOneMonthEmailNotification notification;
    ...
    @Before
    public void setUp() {
        notification = new MotOneMonthEmailNotification(BASE_URL, "urlPrefix", "checksumSalt");
    ...
    public void templateBodyPath_isCorrect() {
        assertEquals("one-month-notification-email-body.txt", notification.getNotificationPathBody());
    }

    @Test
    public void templateSubjectPath_isCorrect() {
        assertEquals("one-month-notification-email-subject.txt", notification.getNotificationPathSubject());
    }
    ...
    public void containsPreservationStatement_ifVehicleHadItsMotTest() {
        ...
        assertEquals(MOT_PRESERVATION_STATEMENT_PREFIX + "21 May" + PRESERVATION_STATEMENT_SUFFIX ,
